...
class TableMedicalRecordDesktop extends StatelessWidget {
  const TableMedicalRecordDesktop({Key? key}) : super(key: key);
            ...
            children: [
              ...
              SizedBox(
                ...
                child: DataTable(
                  ...
                  columns: [
                    DataColumn(
                      label: Text("N°", style: themeData.textTheme.subtitle1),
                    ),
                    DataColumn(
                      label:
                    ...
                    DataColumn(
                      label:
                          Text("Demanda", style: themeData.textTheme.subtitle1),
                    ),
                    DataColumn(
                      label:
                          Text("Status", style: themeData.textTheme.subtitle1),
                    ),
                    DataColumn(
...
DataRow medicalRecordDataRow(
  ...
  return DataRow(
    cells: [
      ...
      DataCell(Text(medicalRecord.demand!, style: textStyle)),
      DataCell(Text(medicalRecord.status!, style: textStyle)),
      DataCell(Row(
        children: [
          IconButton(
              onPressed: () {
          ...
          IconButton(
              onPressed: () {
                showDialog(
                    ...
                    builder: (context) {
                      return Observer(builder: (_) {
                        _medicalRecordStore.setMedicalRecord(medicalRecord);
                        return AlertDialog(
                          content: MedicalRecordForm(
                            update: true,
                          ),
                        );
                      });
